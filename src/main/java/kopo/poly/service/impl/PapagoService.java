...
public class PapagoService implements IPapagoService {
    ...
    @Override
    public Papago1DTO detectLangs(Papago1DTO pDTO) throws Exception {
        ...
        Papago1DTO rDTO = new ObjectMapper().readValue(json, Papago1DTO.class);
    ...
    @Override
    public Papago1DTO translate(Papago1DTO pDTO) throws Exception {

        log.info(this.getClass().getName() + ".translate Start!");

        // 언어 종류 찾기
        Papago1DTO rDTO = this.detectLangs(pDTO);
